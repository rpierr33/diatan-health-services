  ...
  return (
    <>
      ...
      <PhotoBand
        ...
        alt="A person writing in an open notebook on a wooden table beside a cold drink"
        height={310}
        position="center 45%"
        eyebrow="Take what's useful, leave the rest"
        headline="Understanding what you're going through is part of getting better."
      />
